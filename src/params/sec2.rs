...
pub mod p112r1 {
    ...
    pub const B3_BYTES: [u8; 14] = [
        0x55, 0x60, 0xbf, 0x6e, 0xa9, 0xc7, 0xe6, 0x66, 0x1b, 0x24, 0x75, 0xa3, 0x60, 0xdb,
    ];
    /// B*3 factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B3_LIMBS: [u64; 2] = [0x00005560bf6ea9c7, 0xe6661b2475a360db];
...
pub mod p128r1 {
    ...
    pub const B3_BYTES: [u8; 16] = [
        0xb9, 0x60, 0x6d, 0x47, 0x31, 0x6d, 0xdc, 0xb9, 0x88, 0x6d, 0xcb, 0xb4, 0x86, 0xcb, 0x1c,
        0x7b,
    ];
    /// B*3 factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B3_LIMBS: [u64; 2] = [0xb9606d47316ddcb9, 0x886dcbb486cb1c7b];
    /// X-Coordinate of the generator point of the curve (BE bytes representation)
...
pub mod p160k1 {
    ...
    /// P-2 (BE bytes representation)
    pub const PM2_BYTES: [u8; 20] = [
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xfe, 0xff, 0xff, 0xac, 0x71,
    ];
    /// P-2 (BE 64-bits limbs representation)
    pub const PM2_LIMBS: [u64; 3] = [0x00000000ffffffff, 0xffffffffffffffff, 0xfffffffeffffac71];
    /// pre-computed µ barrett modular reduction (BE bytes representation)
    pub const MICRO_BYTES: [u8; 40] = [
        ...
        0x53, 0x8d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    /// pre-computed µ barrett modular reduction (BE 64-bits limbs representation)
    pub const MICRO_LIMBS: [u64; 5] = [
        0x0000000000000000,
        0x0000000100000000,
        0x0000000000000000,
        0x000000010000538d,
    ...
    /// A factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const A_LIMBS: [u64; 3] = [0x0000000000000000, 0x0000000000000000, 0x0000000000000000];
    /// B factor in the short weirstrass curve (BE bytes representation)
    ...
    /// B factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B_LIMBS: [u64; 3] = [0x0000000000000000, 0x0000000000000000, 0x0000000000000007];
    /// B*3 factor in the short weirstrass curve (BE bytes representation)
    pub const B3_BYTES: [u8; 20] = [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x15,
    ];
    /// B*3 factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B3_LIMBS: [u64; 3] = [0x0000000000000000, 0x0000000000000000, 0x0000000000000015];
    /// X-Coordinate of the generator point of the curve (BE bytes representation)
...
pub mod p160r1 {
    ...
    /// P-2 (BE 64-bits limbs representation)
    pub const PM2_LIMBS: [u64; 3] = [0x00000000ffffffff, 0xffffffffffffffff, 0xffffffff7ffffffd];
    /// pre-computed µ barrett modular reduction (BE bytes representation)
    pub const MICRO_BYTES: [u8; 40] = [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
    ...
    /// B*3 factor in the short weirstrass curve (BE bytes representation)
    pub const B3_BYTES: [u8; 20] = [
        0x55, 0xc7, 0x3c, 0xf4, 0xfe, 0x38, 0x6f, 0xa2, 0x31, 0x06, 0xe9, 0xde, 0x85, 0x7e, 0x7e,
        0x09, 0x50, 0x31, 0xee, 0xcf,
    ];
    /// B*3 factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B3_LIMBS: [u64; 3] = [0x0000000055c73cf4, 0xfe386fa23106e9de, 0x857e7e095031eecf];
    /// X-Coordinate of the generator point of the curve (BE bytes representation)
    pub const GX_BYTES: [u8; 20] = [
...
pub mod p160r2 {
    ...
    /// B*3 factor in the short weirstrass curve (BE bytes representation)
    pub const B3_BYTES: [u8; 20] = [
        0x1e, 0xa3, 0x9e, 0x7b, 0xf2, 0x0d, 0xc2, 0xa3, 0x02, 0x05, 0x75, 0xdb, 0x0d, 0x32, 0xe8,
        0x12, 0xdf, 0x0b, 0x41, 0x48,
    ];
    /// B*3 factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B3_LIMBS: [u64; 3] = [0x000000001ea39e7b, 0xf20dc2a3020575db, 0x0d32e812df0b4148];
    /// X-Coordinate of the generator point of the curve (BE bytes representation)
    pub const GX_BYTES: [u8; 20] = [
...
pub mod p192k1 {
    ...
    /// P-2 (BE bytes representation)
    pub const PM2_BYTES: [u8; 24] = [
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xee, 0x35,
    ];
    /// P-2 (BE 64-bits limbs representation)
    pub const PM2_LIMBS: [u64; 3] = [0xffffffffffffffff, 0xffffffffffffffff, 0xfffffffeffffee35];
    /// pre-computed µ barrett modular reduction (BE bytes representation)
    pub const MICRO_BYTES: [u8; 48] = [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    /// B factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B_LIMBS: [u64; 3] = [0x0000000000000000, 0x0000000000000000, 0x0000000000000003];
    /// B*3 factor in the short weirstrass curve (BE bytes representation)
    pub const B3_BYTES: [u8; 24] = [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x09,
    ];
    /// B*3 factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B3_LIMBS: [u64; 3] = [0x0000000000000000, 0x0000000000000000, 0x0000000000000009];
    /// X-Coordinate of the generator point of the curve (BE bytes representation)
...
pub mod p192r1 {
    ...
    pub const PM2_BYTES: [u8; 24] = [
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfd,
    ];
    /// P-2 (BE 64-bits limbs representation)
    pub const PM2_LIMBS: [u64; 3] = [0xffffffffffffffff, 0xfffffffffffffffe, 0xfffffffffffffffd];
    /// pre-computed µ barrett modular reduction (BE bytes representation)
    pub const MICRO_BYTES: [u8; 48] = [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    /// B*3 factor in the short weirstrass curve (BE bytes representation)
    pub const B3_BYTES: [u8; 24] = [
        0x2c, 0x63, 0x0f, 0x4d, 0xb0, 0xd5, 0x82, 0xb5, 0x2e, 0xf7, 0xbd, 0x02, 0x56, 0x6c, 0x90,
        0xde, 0xfc, 0x2a, 0x9c, 0xc6, 0x43, 0xd4, 0x2d, 0x14,
    ];
    /// B*3 factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B3_LIMBS: [u64; 3] = [0x2c630f4db0d582b5, 0x2ef7bd02566c90de, 0xfc2a9cc643d42d14];
    /// X-Coordinate of the generator point of the curve (BE bytes representation)
    pub const GX_BYTES: [u8; 24] = [
...
pub mod p224k1 {
    ...
    /// P-2 (BE bytes representation)
    pub const PM2_BYTES: [u8; 28] = [
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xe5, 0x6b,
    ];
    /// P-2 (BE 64-bits limbs representation)
    pub const PM2_LIMBS: [u64; 4] = [
        0x00000000ffffffff,
        0xffffffffffffffff,
        0xffffffffffffffff,
        0xfffffffeffffe56b,
    ...
    /// pre-computed µ barrett modular reduction (BE bytes representation)
    pub const MICRO_BYTES: [u8; 56] = [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00,
        0x00, 0x1a, 0x93, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    /// pre-computed µ barrett modular reduction (BE 64-bits limbs representation)
    pub const MICRO_LIMBS: [u64; 7] = [
        0x0000000000000000,
        0x0000000000000000,
        0x0000000100000000,
        0x0000000000000000,
...
pub mod p224r1 {
    ...
    /// B*3 factor in the short weirstrass curve (BE bytes representation)
    pub const B3_BYTES: [u8; 28] = [
        0x1c, 0x0f, 0x1f, 0x8f, 0x24, 0x0e, 0x1b, 0x03, 0xdf, 0xc3, 0x97, 0x02, 0xf0, 0xce, 0x12,
        0x29, 0x87, 0x3f, 0x8a, 0x2e, 0x75, 0x21, 0xab, 0xc9, 0x6a, 0x01, 0xff, 0x1a,
    ];
    /// B*3 factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B3_LIMBS: [u64; 4] = [
        0x000000001c0f1f8f,
...
pub mod p256r1 {
    ...
    pub const MICRO_BYTES: [u8; 64] = [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0xff,
        0xff, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x03,
    ];
    /// pre-computed µ barrett modular reduction (BE 64-bits limbs representation)
    pub const MICRO_LIMBS: [u64; 8] = [
    ...
    /// B*3 factor in the short weirstrass curve (BE bytes representation)
    pub const B3_BYTES: [u8; 32] = [
        0x10, 0x52, 0xa1, 0x8a, 0xfe, 0xaf, 0xbb, 0xb6, 0x1b, 0xc3, 0x38, 0x00, 0x63, 0xc9, 0x94,
        0x35, 0x2f, 0x57, 0x14, 0x11, 0x64, 0xfb, 0x12, 0xe2, 0xb3, 0x6a, 0xb4, 0xba, 0x77, 0x77,
        0x20, 0xe2,
    ];
    /// B*3 factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B3_LIMBS: [u64; 4] = [
...
pub mod p384r1 {
    ...
    /// pre-computed µ barrett modular reduction (BE bytes representation)
    pub const MICRO_BYTES: [u8; 96] = [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0x00, 0x00, 0x00, 0x01,
    ];
    /// pre-computed µ barrett modular reduction (BE 64-bits limbs representation)
    pub const MICRO_LIMBS: [u64; 12] = [
        0x0000000000000000,
        0x0000000000000000,
        0x0000000000000000,
        0x0000000000000000,
    ...
    pub const B3_BYTES: [u8; 48] = [
        0x19, 0x93, 0x8e, 0xf7, 0xa6, 0xbc, 0xb7, 0xad, 0xc9, 0xaa, 0x10, 0x43, 0xab, 0xe8, 0x87,
        0x4b, 0x48, 0x58, 0xd5, 0x4c, 0xfb, 0x83, 0xc3, 0x36, 0x09, 0x3c, 0x19, 0xad, 0xf0, 0x3a,
        0x96, 0x12, 0x53, 0x02, 0xac, 0xaa, 0x9e, 0x8c, 0x74, 0xd7, 0x7f, 0x91, 0x5a, 0xc7, 0x7b,
        0xc4, 0x80, 0xcf,
    ];
    /// B*3 factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B3_LIMBS: [u64; 6] = [
        0x19938ef7a6bcb7ad,
        0xc9aa1043abe8874b,
        0x4858d54cfb83c336,
        0x093c19adf03a9612,
...
pub mod p521r1 {
    ...
    /// B*3 factor in the short weirstrass curve (BE bytes representation)
    pub const B3_BYTES: [u8; 66] = [
        0x00, 0xf4, 0xbf, 0xbc, 0x2c, 0x24, 0xaa, 0x55, 0xce, 0x5e, 0xb7, 0xce, 0x64, 0xe2, 0x23,
        0x8f, 0xc2, 0xcb, 0xe8, 0x8f, 0x57, 0x12, 0xcd, 0x19, 0x41, 0xdb, 0x2a, 0x1d, 0x9c, 0xb4,
        0xac, 0xd3, 0x1d, 0xa4, 0x02, 0x4b, 0xab, 0xf5, 0xc5, 0x7b, 0xba, 0x71, 0x42, 0xf8, 0x42,
        0x37, 0xb3, 0x15, 0x3d, 0x15, 0xa0, 0x5b, 0x9e, 0x98, 0xb7, 0x84, 0x9e, 0xd5, 0xcd, 0xcf,
        0x5f, 0x7d, 0x41, 0xf0, 0xbd, 0x00,
    ];
    /// B*3 factor in the short weirstrass curve (BE 64-bits limbs representation)
    pub const B3_LIMBS: [u64; 9] = [
        0x00000000000000f4,
        0xbfbc2c24aa55ce5e,
        0xb7ce64e2238fc2cb,
        0xe88f5712cd1941db,
