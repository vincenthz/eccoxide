//! Curve p128r1 as defined in SEC2.

use crate::curve::fiat::p128r1_64::*;
use crate::curve::fiat::p128r1_scalar_64::*;
...
fiat_field_montgomery_impl!(
    #[doc = "Element of the 128-bit prime field of the SECP128R1 curve"]
    FieldElement,
    128,
    P_LIMBS,
    FE_LIMBS_SIZE,
    fiat_p128r1_non_montgomery_domain_field_element,
    fiat_p128r1_nonzero,
    fiat_p128r1_add,
    fiat_p128r1_sub,
    fiat_p128r1_mul,
    fiat_p128r1_square,
    fiat_p128r1_opp,
    fiat_p128r1_to_bytes,
    fiat_p128r1_from_bytes,
    fiat_p128r1_montgomery_domain_field_element,
    fiat_p128r1_to_montgomery,
    fiat_p128r1_from_montgomery,
    fiat_p128r1_selectznz,
    fiat_p128r1_msat,
    fiat_p128r1_divstep,
    fiat_p128r1_divstep_precomp
);
...
impl FieldElement {
    ...
    pub fn inverse_fermat(&self) -> Self {
        ...
        let x11 = x6.square_rep(5) * &x5;
        let x23 = x12.square_rep(11) * &x11;
        let x47 = x24.square_rep(23) * &x23;
        let x95 = x48.square_rep(47) * &x47;
        let mut t1 = x30.clone();
        t1 = t1.square_rep(96) * &x95;
...
fiat_field_montgomery_impl!(
    #[doc = "Element of the prime field Fp for scalar where p is the order of the SECP128R1 curve"]
    Scalar,
    128,
    ORDER_LIMBS,
    GM_LIMBS_SIZE,
    fiat_p128r1_scalar_non_montgomery_domain_field_element,
    fiat_p128r1_scalar_nonzero,
    fiat_p128r1_scalar_add,
    fiat_p128r1_scalar_sub,
    fiat_p128r1_scalar_mul,
    fiat_p128r1_scalar_square,
    fiat_p128r1_scalar_opp,
    fiat_p128r1_scalar_to_bytes,
    fiat_p128r1_scalar_from_bytes,
    fiat_p128r1_scalar_montgomery_domain_field_element,
    fiat_p128r1_scalar_to_montgomery,
    fiat_p128r1_scalar_from_montgomery,
    fiat_p128r1_scalar_selectznz,
    fiat_p128r1_scalar_msat,
    fiat_p128r1_scalar_divstep,
    fiat_p128r1_scalar_divstep_precomp
);
