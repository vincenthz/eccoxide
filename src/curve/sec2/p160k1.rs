//! Curve p160k1 as defined in SEC2.
//!
//! secp160k1 and secp160r2 share the same base field.

use crate::curve::fiat::p160k1_scalar_64::*;
...
fiat_field_montgomery_impl!(
    #[doc = "Element of the 160-bit prime field of the SECP160K1 curve"]
    FieldElement,
    160,
    P_LIMBS,
    FE_LIMBS_SIZE,
...
fiat_field_montgomery_impl!(
    #[doc = "Element of the prime field Fp for scalar where p is the order of the SECP160K1 curve"]
    Scalar,
    161,
    ORDER_LIMBS,
    GM_LIMBS_SIZE,
    fiat_p160k1_scalar_non_montgomery_domain_field_element,
    fiat_p160k1_scalar_nonzero,
    fiat_p160k1_scalar_add,
    fiat_p160k1_scalar_sub,
    fiat_p160k1_scalar_mul,
    fiat_p160k1_scalar_square,
    fiat_p160k1_scalar_opp,
    fiat_p160k1_scalar_to_bytes,
    fiat_p160k1_scalar_from_bytes,
    fiat_p160k1_scalar_montgomery_domain_field_element,
    fiat_p160k1_scalar_to_montgomery,
    fiat_p160k1_scalar_from_montgomery,
    fiat_p160k1_scalar_selectznz,
    fiat_p160k1_scalar_msat,
    fiat_p160k1_scalar_divstep,
    fiat_p160k1_scalar_divstep_precomp
);
