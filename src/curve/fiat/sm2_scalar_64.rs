//! ```text
//! Autogenerated: 'src/ExtractionOCaml/word_by_word_montgomery' --lang Rust --inline sm2_scalar 64 '2^256 - 2^224 - 188730267045675049073202170516080344797' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
/// ```
#[inline]
pub const fn fiat_sm2_scalar_to_bytes(mut out1: &mut [u8; 32], arg1: &[u64; 4]) {
...
/// ```
#[inline]
pub const fn fiat_sm2_scalar_from_bytes(mut out1: &mut [u64; 4], arg1: &[u8; 32]) {
...
///
#[inline]
pub const fn fiat_sm2_scalar_set_one(
    mut out1: &mut fiat_sm2_scalar_montgomery_domain_field_element,
) {
    *IndexConst(&mut out1).index_mut(0) = 0xac440bf6c62abedd;
    *IndexConst(&mut out1).index_mut(1) = 0x8dfc2094de39fad4;
