...
///   out2: [0x0 ~> 0x1]
#[inline]
pub fn fiat_p256_addcarryx_u64(
    out1: &mut u64,
...
///   out2: [0x0 ~> 0x1]
#[inline]
pub fn fiat_p256_subborrowx_u64(
    out1: &mut u64,
    out2: &mut fiat_p256_u1,
    arg1: fiat_p256_u1,
    arg2: u64,
...
///
#[inline]
pub fn fiat_p256_from_montgomery(
...
///
#[inline]
pub fn fiat_p256_to_montgomery(
    out1: &mut fiat_p256_montgomery_domain_field_element,
...
pub fn fiat_p256_divstep(
    ...
    let x3: fiat_p256_u1 =
        (((x1 >> 63) as fiat_p256_u1) & (((arg3[0]) & (0x1 as u64)) as fiat_p256_u1));
    let mut x4: u64 = 0;
