...
impl<'a> IndexConst<&'a fiat_p256_montgomery_domain_field_element> {
    #[allow(unused)]
    #[inline(always)]
...
impl<'a, 'b> IndexConst<&'a mut &'b mut fiat_p256_montgomery_domain_field_element> {
    #[allow(unused)]
    #[inline(always)]
...
impl<'a> IndexConst<&'a fiat_p256_non_montgomery_domain_field_element> {
    #[allow(unused)]
    #[inline(always)]
    const fn index(self, i: usize) -> &'a u64 {
        &self.0 .0[i]
...
impl<'a, 'b> IndexConst<&'a mut &'b mut fiat_p256_non_montgomery_domain_field_element> {
    #[allow(unused)]
    #[inline(always)]
    const fn index_mut(self, i: usize) -> &'a mut u64 {
        &mut self.0 .0[i]
...
/// ```
#[inline]
pub const fn fiat_p256_addcarryx_u64(
    out1: &mut u64,
    out2: &mut fiat_p256_u1,
    arg1: fiat_p256_u1,
    arg2: u64,
    arg3: u64,
) {
...
/// ```
#[inline]
pub const fn fiat_p256_subborrowx_u64(
    out1: &mut u64,
    out2: &mut fiat_p256_u1,
    arg1: fiat_p256_u1,
    arg2: u64,
...
/// ```
#[inline]
pub const fn fiat_p256_mulx_u64(out1: &mut u64, out2: &mut u64, arg1: u64, arg2: u64) {
...
pub const fn fiat_p256_cmovznz_u64(out1: &mut u64, arg1: fiat_p256_u1, arg2: u64, arg3: u64) {
    ...
    let x2: u64 = ((((((0x0 as fiat_p256_i2) - (x1 as fiat_p256_i2)) as fiat_p256_i1) as i128)
...
pub const fn fiat_p256_mul(
    mut out1: &mut fiat_p256_montgomery_domain_field_element,
    ...
    let mut x5: u64 = 0;
    let mut x6: u64 = 0;
    fiat_p256_mulx_u64(&mut x5, &mut x6, x4, (*IndexConst(arg2).index(3)));
    let mut x7: u64 = 0;
    let mut x8: u64 = 0;
    fiat_p256_mulx_u64(&mut x7, &mut x8, x4, (*IndexConst(arg2).index(2)));
    let mut x9: u64 = 0;
    let mut x10: u64 = 0;
    fiat_p256_mulx_u64(&mut x9, &mut x10, x4, (*IndexConst(arg2).index(1)));
    let mut x11: u64 = 0;
    let mut x12: u64 = 0;
    fiat_p256_mulx_u64(&mut x11, &mut x12, x4, (*IndexConst(arg2).index(0)));
    let mut x13: u64 = 0;
    ...
    let mut x39: u64 = 0;
    let mut x40: u64 = 0;
    fiat_p256_mulx_u64(&mut x39, &mut x40, x1, (*IndexConst(arg2).index(3)));
    let mut x41: u64 = 0;
    let mut x42: u64 = 0;
    fiat_p256_mulx_u64(&mut x41, &mut x42, x1, (*IndexConst(arg2).index(2)));
    let mut x43: u64 = 0;
    let mut x44: u64 = 0;
    fiat_p256_mulx_u64(&mut x43, &mut x44, x1, (*IndexConst(arg2).index(1)));
    let mut x45: u64 = 0;
    let mut x46: u64 = 0;
    fiat_p256_mulx_u64(&mut x45, &mut x46, x1, (*IndexConst(arg2).index(0)));
    let mut x47: u64 = 0;
    ...
    let mut x84: u64 = 0;
    let mut x85: u64 = 0;
    fiat_p256_mulx_u64(&mut x84, &mut x85, x2, (*IndexConst(arg2).index(3)));
    let mut x86: u64 = 0;
    let mut x87: u64 = 0;
    fiat_p256_mulx_u64(&mut x86, &mut x87, x2, (*IndexConst(arg2).index(2)));
    let mut x88: u64 = 0;
    let mut x89: u64 = 0;
    fiat_p256_mulx_u64(&mut x88, &mut x89, x2, (*IndexConst(arg2).index(1)));
    let mut x90: u64 = 0;
    let mut x91: u64 = 0;
    fiat_p256_mulx_u64(&mut x90, &mut x91, x2, (*IndexConst(arg2).index(0)));
    let mut x92: u64 = 0;
    ...
    let mut x129: u64 = 0;
    let mut x130: u64 = 0;
    fiat_p256_mulx_u64(&mut x129, &mut x130, x3, (*IndexConst(arg2).index(3)));
    let mut x131: u64 = 0;
    let mut x132: u64 = 0;
    fiat_p256_mulx_u64(&mut x131, &mut x132, x3, (*IndexConst(arg2).index(2)));
    let mut x133: u64 = 0;
    let mut x134: u64 = 0;
    fiat_p256_mulx_u64(&mut x133, &mut x134, x3, (*IndexConst(arg2).index(1)));
    let mut x135: u64 = 0;
    let mut x136: u64 = 0;
    fiat_p256_mulx_u64(&mut x135, &mut x136, x3, (*IndexConst(arg2).index(0)));
    let mut x137: u64 = 0;
    ...
    *IndexConst(&mut out1).index_mut(0) = x184;
    *IndexConst(&mut out1).index_mut(1) = x185;
    *IndexConst(&mut out1).index_mut(2) = x186;
    *IndexConst(&mut out1).index_mut(3) = x187;
}
...
pub const fn fiat_p256_square(
    ...
    let mut x5: u64 = 0;
    let mut x6: u64 = 0;
    fiat_p256_mulx_u64(&mut x5, &mut x6, x4, (*IndexConst(arg1).index(3)));
    let mut x7: u64 = 0;
    let mut x8: u64 = 0;
    fiat_p256_mulx_u64(&mut x7, &mut x8, x4, (*IndexConst(arg1).index(2)));
    let mut x9: u64 = 0;
    let mut x10: u64 = 0;
    fiat_p256_mulx_u64(&mut x9, &mut x10, x4, (*IndexConst(arg1).index(1)));
    let mut x11: u64 = 0;
    let mut x12: u64 = 0;
    fiat_p256_mulx_u64(&mut x11, &mut x12, x4, (*IndexConst(arg1).index(0)));
    let mut x13: u64 = 0;
    let mut x14: fiat_p256_u1 = 0;
    fiat_p256_addcarryx_u64(&mut x13, &mut x14, 0x0, x12, x9);
    let mut x15: u64 = 0;
    ...
    let mut x39: u64 = 0;
    let mut x40: u64 = 0;
    fiat_p256_mulx_u64(&mut x39, &mut x40, x1, (*IndexConst(arg1).index(3)));
    let mut x41: u64 = 0;
    let mut x42: u64 = 0;
    fiat_p256_mulx_u64(&mut x41, &mut x42, x1, (*IndexConst(arg1).index(2)));
    let mut x43: u64 = 0;
    let mut x44: u64 = 0;
    fiat_p256_mulx_u64(&mut x43, &mut x44, x1, (*IndexConst(arg1).index(1)));
    let mut x45: u64 = 0;
    let mut x46: u64 = 0;
    fiat_p256_mulx_u64(&mut x45, &mut x46, x1, (*IndexConst(arg1).index(0)));
    let mut x47: u64 = 0;
    let mut x48: fiat_p256_u1 = 0;
    fiat_p256_addcarryx_u64(&mut x47, &mut x48, 0x0, x46, x43);
    let mut x49: u64 = 0;
    ...
    let mut x84: u64 = 0;
    let mut x85: u64 = 0;
    fiat_p256_mulx_u64(&mut x84, &mut x85, x2, (*IndexConst(arg1).index(3)));
    let mut x86: u64 = 0;
    let mut x87: u64 = 0;
    fiat_p256_mulx_u64(&mut x86, &mut x87, x2, (*IndexConst(arg1).index(2)));
    let mut x88: u64 = 0;
    let mut x89: u64 = 0;
    fiat_p256_mulx_u64(&mut x88, &mut x89, x2, (*IndexConst(arg1).index(1)));
    let mut x90: u64 = 0;
    let mut x91: u64 = 0;
    fiat_p256_mulx_u64(&mut x90, &mut x91, x2, (*IndexConst(arg1).index(0)));
    let mut x92: u64 = 0;
    let mut x93: fiat_p256_u1 = 0;
    fiat_p256_addcarryx_u64(&mut x92, &mut x93, 0x0, x91, x88);
    let mut x94: u64 = 0;
    ...
    let mut x129: u64 = 0;
    let mut x130: u64 = 0;
    fiat_p256_mulx_u64(&mut x129, &mut x130, x3, (*IndexConst(arg1).index(3)));
    let mut x131: u64 = 0;
    let mut x132: u64 = 0;
    fiat_p256_mulx_u64(&mut x131, &mut x132, x3, (*IndexConst(arg1).index(2)));
    let mut x133: u64 = 0;
    let mut x134: u64 = 0;
    fiat_p256_mulx_u64(&mut x133, &mut x134, x3, (*IndexConst(arg1).index(1)));
    let mut x135: u64 = 0;
    let mut x136: u64 = 0;
    fiat_p256_mulx_u64(&mut x135, &mut x136, x3, (*IndexConst(arg1).index(0)));
    let mut x137: u64 = 0;
    let mut x138: fiat_p256_u1 = 0;
    fiat_p256_addcarryx_u64(&mut x137, &mut x138, 0x0, x136, x133);
    let mut x139: u64 = 0;
...
pub const fn fiat_p256_from_montgomery(
    mut out1: &mut fiat_p256_non_montgomery_domain_field_element,
    arg1: &fiat_p256_montgomery_domain_field_element,
) {
    ...
    let mut x14: u64 = 0;
    let mut x15: fiat_p256_u1 = 0;
    fiat_p256_addcarryx_u64(&mut x14, &mut x15, 0x0, x12, (*IndexConst(arg1).index(1)));
    let mut x16: u64 = 0;
    let mut x17: u64 = 0;
    ...
    fiat_p256_addcarryx_u64(&mut x32, &mut x33, 0x0, x26, (*IndexConst(arg1).index(2)));
    let mut x34: u64 = 0;
    ...
    fiat_p256_addcarryx_u64(
        ...
        &mut x53,
        x51,
        ((x37 as u64) + ((x31 as u64) + x17)),
        x38,
    );
    let mut x54: u64 = 0;
    let mut x55: fiat_p256_u1 = 0;
    fiat_p256_addcarryx_u64(&mut x54, &mut x55, 0x0, x48, (*IndexConst(arg1).index(3)));
    let mut x56: u64 = 0;
    let mut x57: fiat_p256_u1 = 0;
    ...
    *IndexConst(&mut out1).index_mut(0) = x87;
    *IndexConst(&mut out1).index_mut(1) = x88;
    *IndexConst(&mut out1).index_mut(2) = x89;
    *IndexConst(&mut out1).index_mut(3) = x90;
}
...
pub const fn fiat_p256_to_montgomery(
    ...
    fiat_p256_addcarryx_u64(
        ...
        &mut x76,
        x74,
        (((x58 as u64) + (x36 as u64)) + ((x50 as u64) + x38)),
        x60,
    );
    let mut x77: u64 = 0;
    let mut x78: u64 = 0;
    ...
    fiat_p256_addcarryx_u64(
        ...
        &mut x116,
        x114,
        (((x98 as u64) + (x76 as u64)) + ((x90 as u64) + x78)),
        x100,
    );
    let mut x117: u64 = 0;
    let mut x118: u64 = 0;
    ...
    fiat_p256_addcarryx_u64(
        ...
        &mut x156,
        x154,
        (((x138 as u64) + (x116 as u64)) + ((x130 as u64) + x118)),
        x140,
    );
    let mut x157: u64 = 0;
    ...
    *IndexConst(&mut out1).index_mut(0) = x167;
    *IndexConst(&mut out1).index_mut(1) = x168;
    *IndexConst(&mut out1).index_mut(2) = x169;
    *IndexConst(&mut out1).index_mut(3) = x170;
}
...
/// ```
#[inline]
pub const fn fiat_p256_nonzero(out1: &mut u64, arg1: &[u64; 4]) {
    let x1: u64 = ((*IndexConst(arg1).index(0))
        | ((*IndexConst(arg1).index(1))
...
/// ```
#[inline]
pub const fn fiat_p256_selectznz(
    mut out1: &mut [u64; 4],
    arg1: fiat_p256_u1,
    arg2: &[u64; 4],
    arg3: &[u64; 4],
...
/// ```
#[inline]
pub const fn fiat_p256_to_bytes(mut out1: &mut [u8; 32], arg1: &[u64; 4]) {
...
/// ```
#[inline]
pub const fn fiat_p256_from_bytes(mut out1: &mut [u64; 4], arg1: &[u8; 32]) {
...
///
#[inline]
pub const fn fiat_p256_set_one(mut out1: &mut fiat_p256_montgomery_domain_field_element) {
    ...
    *IndexConst(&mut out1).index_mut(3) = 0xfffffffe;
}
...
/// ```
#[inline]
pub const fn fiat_p256_msat(mut out1: &mut [u64; 5]) {
    ...
    *IndexConst(&mut out1).index_mut(3) = 0xffffffff00000001;
...
pub const fn fiat_p256_divstep(
    ...
    let x3: fiat_p256_u1 = (((x1 >> 63) as fiat_p256_u1)
        & (((*IndexConst(arg3).index(0)) & (0x1 as u64)) as fiat_p256_u1));
    let mut x4: u64 = 0;
    ...
    let mut x22: u64 = 0;
    fiat_p256_cmovznz_u64(&mut x22, x3, (*IndexConst(arg3).index(0)), x12);
    let mut x23: u64 = 0;
    fiat_p256_cmovznz_u64(&mut x23, x3, (*IndexConst(arg3).index(1)), x14);
    let mut x24: u64 = 0;
    fiat_p256_cmovznz_u64(&mut x24, x3, (*IndexConst(arg3).index(2)), x16);
    let mut x25: u64 = 0;
    fiat_p256_cmovznz_u64(&mut x25, x3, (*IndexConst(arg3).index(3)), x18);
    let mut x26: u64 = 0;
    fiat_p256_cmovznz_u64(&mut x26, x3, (*IndexConst(arg3).index(4)), x20);
    let mut x27: u64 = 0;
    fiat_p256_cmovznz_u64(
        &mut x27,
        x3,
    ...
    let mut x70: u64 = 0;
    fiat_p256_cmovznz_u64(&mut x70, x3, (*IndexConst(arg5).index(0)), x62);
    let mut x71: u64 = 0;
    fiat_p256_cmovznz_u64(&mut x71, x3, (*IndexConst(arg5).index(1)), x64);
    let mut x72: u64 = 0;
    fiat_p256_cmovznz_u64(&mut x72, x3, (*IndexConst(arg5).index(2)), x66);
    let mut x73: u64 = 0;
    fiat_p256_cmovznz_u64(&mut x73, x3, (*IndexConst(arg5).index(3)), x68);
...
/// ```
#[inline]
pub const fn fiat_p256_divstep_precomp(mut out1: &mut [u64; 4]) {
    *IndexConst(&mut out1).index_mut(0) = 0x67ffffffb8000000;
    *IndexConst(&mut out1).index_mut(1) = 0xc000000038000000;
    *IndexConst(&mut out1).index_mut(2) = 0xd80000007fffffff;
    *IndexConst(&mut out1).index_mut(3) = 0x2fffffffffffffff;
}
