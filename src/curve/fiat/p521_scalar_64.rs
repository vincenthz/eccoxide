//! Autogenerated: 'src/ExtractionOCaml/word_by_word_montgomery' --lang Rust --inline p521_scalar 64 '2^521 - 657877501894328237357444332315020117536923257219387276263472201219398408051703' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
///
#[inline]
pub fn fiat_p521_scalar_square(
    out1: &mut fiat_p521_scalar_montgomery_domain_field_element,
    arg1: &fiat_p521_scalar_montgomery_domain_field_element,
) -> () {
    let x1: u64 = (arg1[1]);
...
///
#[inline]
pub fn fiat_p521_scalar_from_montgomery(
...
///
#[inline]
pub fn fiat_p521_scalar_to_montgomery(
    out1: &mut fiat_p521_scalar_montgomery_domain_field_element,
...
#[inline]
pub fn fiat_p521_scalar_divstep(
    out1: &mut u64,
    out2: &mut [u64; 10],
    out3: &mut [u64; 10],
    out4: &mut [u64; 9],
