...
/// ```
#[inline]
pub const fn fiat_p384_scalar_to_bytes(mut out1: &mut [u8; 48], arg1: &[u64; 6]) {
...
/// ```
#[inline]
pub const fn fiat_p384_scalar_from_bytes(mut out1: &mut [u64; 6], arg1: &[u8; 48]) {
...
///
#[inline]
pub const fn fiat_p384_scalar_set_one(
    mut out1: &mut fiat_p384_scalar_montgomery_domain_field_element,
) {
    *IndexConst(&mut out1).index_mut(0) = 0x1313e695333ad68d;
    *IndexConst(&mut out1).index_mut(1) = 0xa7e5f24db74f5885;
    *IndexConst(&mut out1).index_mut(2) = 0x389cb27e0bc8d220;
