//! ```text
//! Autogenerated: 'src/ExtractionOCaml/word_by_word_montgomery' --lang Rust --inline p224_scalar 64 '2^224 - 4733179336708116180759420887881155' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
/// ```
#[inline]
pub const fn fiat_p224_scalar_to_bytes(mut out1: &mut [u8; 28], arg1: &[u64; 4]) {
...
/// ```
#[inline]
pub const fn fiat_p224_scalar_from_bytes(mut out1: &mut [u64; 4], arg1: &[u8; 28]) {
...
///
#[inline]
pub const fn fiat_p224_scalar_set_one(
    mut out1: &mut fiat_p224_scalar_montgomery_domain_field_element,
) {
    *IndexConst(&mut out1).index_mut(0) = 0xa3a3d5c300000000;
    *IndexConst(&mut out1).index_mut(1) = 0x1f470fc1ec22d6ba;
    *IndexConst(&mut out1).index_mut(2) = 0xe95d;
