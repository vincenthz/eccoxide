...
///   out2: [0x0 ~> 0x1]
#[inline]
pub fn fiat_secp256k1_addcarryx_u64(
    out1: &mut u64,
    out2: &mut fiat_secp256k1_u1,
...
///   out2: [0x0 ~> 0x1]
#[inline]
pub fn fiat_secp256k1_subborrowx_u64(
    out1: &mut u64,
    out2: &mut fiat_secp256k1_u1,
    arg1: fiat_secp256k1_u1,
    arg2: u64,
...
///   out1: [0x0 ~> 0xffffffffffffffff]
#[inline]
pub fn fiat_secp256k1_cmovznz_u64(
    out1: &mut u64,
    arg1: fiat_secp256k1_u1,
    arg2: u64,
    arg3: u64,
    ...
    let x2: u64 = ((((((0x0 as fiat_secp256k1_i2) - (x1 as fiat_secp256k1_i2)) as fiat_secp256k1_i1)
        as i128)
...
///
#[inline]
pub fn fiat_secp256k1_mul(
    out1: &mut fiat_secp256k1_montgomery_domain_field_element,
    arg1: &fiat_secp256k1_montgomery_domain_field_element,
    arg2: &fiat_secp256k1_montgomery_domain_field_element,
) -> () {
    let x1: u64 = (arg1[1]);
    let x2: u64 = (arg1[2]);
    let x3: u64 = (arg1[3]);
...
///
#[inline]
pub fn fiat_secp256k1_from_montgomery(
    out1: &mut fiat_secp256k1_non_montgomery_domain_field_element,
    arg1: &fiat_secp256k1_montgomery_domain_field_element,
) -> () {
    let x1: u64 = (arg1[0]);
    let mut x2: u64 = 0;
...
///
#[inline]
pub fn fiat_secp256k1_to_montgomery(
    out1: &mut fiat_secp256k1_montgomery_domain_field_element,
    arg1: &fiat_secp256k1_non_montgomery_domain_field_element,
) -> () {
    let x1: u64 = (arg1[1]);
    let x2: u64 = (arg1[2]);
    let x3: u64 = (arg1[3]);
...
pub fn fiat_secp256k1_divstep(
    ...
    let x3: fiat_secp256k1_u1 =
        (((x1 >> 63) as fiat_secp256k1_u1) & (((arg3[0]) & (0x1 as u64)) as fiat_secp256k1_u1));
    let mut x4: u64 = 0;
