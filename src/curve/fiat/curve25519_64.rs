...
/// ```
#[inline]
pub const fn fiat_25519_addcarryx_u51(
    out1: &mut u64,
...
/// ```
#[inline]
pub const fn fiat_25519_subborrowx_u51(
    out1: &mut u64,
    out2: &mut fiat_25519_u1,
    arg1: fiat_25519_u1,
    arg2: u64,
...
///
#[inline]
pub const fn fiat_25519_carry_mul(
    mut out1: &mut fiat_25519_tight_field_element,
    arg1: &fiat_25519_loose_field_element,
    arg2: &fiat_25519_loose_field_element,
) {
    let x1: u128 =
        (((*IndexConst(arg1).index(4)) as u128) * (((*IndexConst(arg2).index(4)) * 0x13) as u128));
    let x2: u128 =
        (((*IndexConst(arg1).index(4)) as u128) * (((*IndexConst(arg2).index(3)) * 0x13) as u128));
    let x3: u128 =
        (((*IndexConst(arg1).index(4)) as u128) * (((*IndexConst(arg2).index(2)) * 0x13) as u128));
    let x4: u128 =
        (((*IndexConst(arg1).index(4)) as u128) * (((*IndexConst(arg2).index(1)) * 0x13) as u128));
    let x5: u128 =
        (((*IndexConst(arg1).index(3)) as u128) * (((*IndexConst(arg2).index(4)) * 0x13) as u128));
    let x6: u128 =
        (((*IndexConst(arg1).index(3)) as u128) * (((*IndexConst(arg2).index(3)) * 0x13) as u128));
    let x7: u128 =
        (((*IndexConst(arg1).index(3)) as u128) * (((*IndexConst(arg2).index(2)) * 0x13) as u128));
    let x8: u128 =
        (((*IndexConst(arg1).index(2)) as u128) * (((*IndexConst(arg2).index(4)) * 0x13) as u128));
    let x9: u128 =
        (((*IndexConst(arg1).index(2)) as u128) * (((*IndexConst(arg2).index(3)) * 0x13) as u128));
    let x10: u128 =
        (((*IndexConst(arg1).index(1)) as u128) * (((*IndexConst(arg2).index(4)) * 0x13) as u128));
    let x11: u128 =
...
///
#[inline]
pub const fn fiat_25519_carry_square(
    mut out1: &mut fiat_25519_tight_field_element,
    arg1: &fiat_25519_loose_field_element,
) {
...
///
#[inline]
pub const fn fiat_25519_add(
    mut out1: &mut fiat_25519_loose_field_element,
...
/// ```
#[inline]
pub const fn fiat_25519_selectznz(
    mut out1: &mut [u64; 5],
    arg1: fiat_25519_u1,
    arg2: &[u64; 5],
    arg3: &[u64; 5],
...
///
#[inline]
pub const fn fiat_25519_carry_scmul_121666(
    mut out1: &mut fiat_25519_tight_field_element,
    arg1: &fiat_25519_loose_field_element,
) {
