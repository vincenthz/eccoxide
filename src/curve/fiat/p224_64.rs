//! ```text
//! Autogenerated: 'src/ExtractionOCaml/word_by_word_montgomery' --lang Rust --inline p224 64 '2^224 - 2^96 + 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
/// ```
#[inline]
pub const fn fiat_p224_to_bytes(mut out1: &mut [u8; 28], arg1: &[u64; 4]) {
...
/// ```
#[inline]
pub const fn fiat_p224_from_bytes(mut out1: &mut [u64; 4], arg1: &[u8; 28]) {
...
///
#[inline]
pub const fn fiat_p224_set_one(mut out1: &mut fiat_p224_montgomery_domain_field_element) {
    *IndexConst(&mut out1).index_mut(0) = 0xffffffff00000000;
