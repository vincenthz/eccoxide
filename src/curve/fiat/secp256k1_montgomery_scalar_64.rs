...
impl core::ops::IndexMut<usize>
    for fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element
{
    #[inline]
...
impl<'a> IndexConst<&'a fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element> {
    #[allow(unused)]
    #[inline(always)]
...
impl<'a, 'b>
    IndexConst<&'a mut &'b mut fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element>
{
    #[allow(unused)]
    #[inline(always)]
...
impl core::ops::Index<usize>
    for fiat_secp256k1_montgomery_scalar_non_montgomery_domain_field_element
{
    type Output = u64;
    #[inline]
    fn index(&self, index: usize) -> &Self::Output {
...
impl<'a> IndexConst<&'a fiat_secp256k1_montgomery_scalar_non_montgomery_domain_field_element> {
    #[allow(unused)]
    #[inline(always)]
    const fn index(self, i: usize) -> &'a u64 {
        &self.0 .0[i]
...
impl<'a, 'b>
    IndexConst<&'a mut &'b mut fiat_secp256k1_montgomery_scalar_non_montgomery_domain_field_element>
{
    #[allow(unused)]
    #[inline(always)]
    const fn index_mut(self, i: usize) -> &'a mut u64 {
...
/// ```
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_addcarryx_u64(
    out1: &mut u64,
    ...
    let x3: fiat_secp256k1_montgomery_scalar_u1 =
...
/// ```
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_subborrowx_u64(
    out1: &mut u64,
    out2: &mut fiat_secp256k1_montgomery_scalar_u1,
    arg1: fiat_secp256k1_montgomery_scalar_u1,
    arg2: u64,
    ...
    let x2: fiat_secp256k1_montgomery_scalar_i1 =
        ((x1 >> 64) as fiat_secp256k1_montgomery_scalar_i1);
    let x3: u64 = ((x1 & (0xffffffffffffffff as i128)) as u64);
    *out1 = x3;
    *out2 = (((0x0 as fiat_secp256k1_montgomery_scalar_i2)
        - (x2 as fiat_secp256k1_montgomery_scalar_i2))
...
/// ```
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_mulx_u64(
    out1: &mut u64,
    out2: &mut u64,
    arg1: u64,
    arg2: u64,
...
/// ```
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_cmovznz_u64(
    out1: &mut u64,
    arg1: fiat_secp256k1_montgomery_scalar_u1,
    arg2: u64,
    arg3: u64,
    ...
    let x2: u64 = ((((((0x0 as fiat_secp256k1_montgomery_scalar_i2)
        - (x1 as fiat_secp256k1_montgomery_scalar_i2))
        as fiat_secp256k1_montgomery_scalar_i1) as i128)
...
///
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_mul(
    mut out1: &mut fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
    arg1: &fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
    arg2: &fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
) {
    ...
    let mut x5: u64 = 0;
    let mut x6: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x5, &mut x6, x4, (*IndexConst(arg2).index(3)));
    let mut x7: u64 = 0;
    let mut x8: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x7, &mut x8, x4, (*IndexConst(arg2).index(2)));
    let mut x9: u64 = 0;
    let mut x10: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x9, &mut x10, x4, (*IndexConst(arg2).index(1)));
    let mut x11: u64 = 0;
    let mut x12: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x11, &mut x12, x4, (*IndexConst(arg2).index(0)));
    let mut x13: u64 = 0;
    ...
    let mut x47: u64 = 0;
    let mut x48: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x47, &mut x48, x1, (*IndexConst(arg2).index(3)));
    let mut x49: u64 = 0;
    let mut x50: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x49, &mut x50, x1, (*IndexConst(arg2).index(2)));
    let mut x51: u64 = 0;
    let mut x52: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x51, &mut x52, x1, (*IndexConst(arg2).index(1)));
    let mut x53: u64 = 0;
    let mut x54: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x53, &mut x54, x1, (*IndexConst(arg2).index(0)));
    let mut x55: u64 = 0;
    ...
    fiat_secp256k1_montgomery_scalar_subborrowx_u64(
        &mut x206,
        &mut x207,
        0x0,
        x197,
...
///
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_square(
    mut out1: &mut fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
    arg1: &fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
) {
    let x1: u64 = (*IndexConst(arg1).index(1));
    ...
    let mut x5: u64 = 0;
    let mut x6: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x5, &mut x6, x4, (*IndexConst(arg1).index(3)));
    let mut x7: u64 = 0;
    let mut x8: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x7, &mut x8, x4, (*IndexConst(arg1).index(2)));
    let mut x9: u64 = 0;
    let mut x10: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x9, &mut x10, x4, (*IndexConst(arg1).index(1)));
    let mut x11: u64 = 0;
    let mut x12: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x11, &mut x12, x4, (*IndexConst(arg1).index(0)));
    let mut x13: u64 = 0;
    let mut x14: fiat_secp256k1_montgomery_scalar_u1 = 0;
    fiat_secp256k1_montgomery_scalar_addcarryx_u64(&mut x13, &mut x14, 0x0, x12, x9);
    let mut x15: u64 = 0;
    ...
    let mut x47: u64 = 0;
    let mut x48: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x47, &mut x48, x1, (*IndexConst(arg1).index(3)));
    let mut x49: u64 = 0;
    let mut x50: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x49, &mut x50, x1, (*IndexConst(arg1).index(2)));
    let mut x51: u64 = 0;
    let mut x52: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x51, &mut x52, x1, (*IndexConst(arg1).index(1)));
    let mut x53: u64 = 0;
    let mut x54: u64 = 0;
    fiat_secp256k1_montgomery_scalar_mulx_u64(&mut x53, &mut x54, x1, (*IndexConst(arg1).index(0)));
    let mut x55: u64 = 0;
    let mut x56: fiat_secp256k1_montgomery_scalar_u1 = 0;
    fiat_secp256k1_montgomery_scalar_addcarryx_u64(&mut x55, &mut x56, 0x0, x54, x51);
    let mut x57: u64 = 0;
...
///
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_add(
    mut out1: &mut fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
    arg1: &fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
    arg2: &fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
) {
    ...
    fiat_secp256k1_montgomery_scalar_addcarryx_u64(
        &mut x1,
        &mut x2,
        0x0,
        (*IndexConst(arg1).index(0)),
...
///
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_sub(
    mut out1: &mut fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
    arg1: &fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
    arg2: &fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
) {
...
///
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_opp(
    mut out1: &mut fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
    arg1: &fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
) {
    let mut x1: u64 = 0;
...
///
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_from_montgomery(
    mut out1: &mut fiat_secp256k1_montgomery_scalar_non_montgomery_domain_field_element,
    arg1: &fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
) {
...
///
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_to_montgomery(
    mut out1: &mut fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
...
/// ```
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_nonzero(out1: &mut u64, arg1: &[u64; 4]) {
    let x1: u64 = ((*IndexConst(arg1).index(0))
        | ((*IndexConst(arg1).index(1))
...
/// ```
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_selectznz(
    mut out1: &mut [u64; 4],
    arg1: fiat_secp256k1_montgomery_scalar_u1,
    arg2: &[u64; 4],
    arg3: &[u64; 4],
...
/// ```
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_to_bytes(mut out1: &mut [u8; 32], arg1: &[u64; 4]) {
...
/// ```
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_from_bytes(mut out1: &mut [u64; 4], arg1: &[u8; 32]) {
...
///
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_set_one(
    mut out1: &mut fiat_secp256k1_montgomery_scalar_montgomery_domain_field_element,
) {
    *IndexConst(&mut out1).index_mut(0) = 0x402da1732fc9bebf;
    *IndexConst(&mut out1).index_mut(1) = 0x4551231950b75fc4;
...
/// ```
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_msat(mut out1: &mut [u64; 5]) {
    *IndexConst(&mut out1).index_mut(0) = 0xbfd25e8cd0364141;
    *IndexConst(&mut out1).index_mut(1) = 0xbaaedce6af48a03b;
...
/// ```
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_divstep(
    out1: &mut u64,
    mut out2: &mut [u64; 5],
    mut out3: &mut [u64; 5],
    mut out4: &mut [u64; 4],
    ...
    let x3: fiat_secp256k1_montgomery_scalar_u1 = (((x1 >> 63)
        as fiat_secp256k1_montgomery_scalar_u1)
        & (((*IndexConst(arg3).index(0)) & (0x1 as u64)) as fiat_secp256k1_montgomery_scalar_u1));
    let mut x4: u64 = 0;
    ...
    let mut x22: u64 = 0;
    fiat_secp256k1_montgomery_scalar_cmovznz_u64(&mut x22, x3, (*IndexConst(arg3).index(0)), x12);
    let mut x23: u64 = 0;
    fiat_secp256k1_montgomery_scalar_cmovznz_u64(&mut x23, x3, (*IndexConst(arg3).index(1)), x14);
    let mut x24: u64 = 0;
    fiat_secp256k1_montgomery_scalar_cmovznz_u64(&mut x24, x3, (*IndexConst(arg3).index(2)), x16);
    let mut x25: u64 = 0;
    fiat_secp256k1_montgomery_scalar_cmovznz_u64(&mut x25, x3, (*IndexConst(arg3).index(3)), x18);
    let mut x26: u64 = 0;
    fiat_secp256k1_montgomery_scalar_cmovznz_u64(&mut x26, x3, (*IndexConst(arg3).index(4)), x20);
    let mut x27: u64 = 0;
    fiat_secp256k1_montgomery_scalar_cmovznz_u64(
        &mut x27,
        x3,
    ...
    fiat_secp256k1_montgomery_scalar_addcarryx_u64(
        ...
        x65,
        x57,
        (x61 & 0xfffffffffffffffe),
    );
    let mut x68: u64 = 0;
    let mut x69: fiat_secp256k1_montgomery_scalar_u1 = 0;
    fiat_secp256k1_montgomery_scalar_addcarryx_u64(&mut x68, &mut x69, x67, x59, x61);
    let mut x70: u64 = 0;
    fiat_secp256k1_montgomery_scalar_cmovznz_u64(&mut x70, x3, (*IndexConst(arg5).index(0)), x62);
    let mut x71: u64 = 0;
    fiat_secp256k1_montgomery_scalar_cmovznz_u64(&mut x71, x3, (*IndexConst(arg5).index(1)), x64);
    let mut x72: u64 = 0;
    fiat_secp256k1_montgomery_scalar_cmovznz_u64(&mut x72, x3, (*IndexConst(arg5).index(2)), x66);
    let mut x73: u64 = 0;
    fiat_secp256k1_montgomery_scalar_cmovznz_u64(&mut x73, x3, (*IndexConst(arg5).index(3)), x68);
    let x74: fiat_secp256k1_montgomery_scalar_u1 =
...
/// ```
#[inline]
pub const fn fiat_secp256k1_montgomery_scalar_divstep_precomp(mut out1: &mut [u64; 4]) {
    *IndexConst(&mut out1).index_mut(0) = 0xd7431a4d2b9cb4e9;
    *IndexConst(&mut out1).index_mut(1) = 0xab67d35a32d9c503;
    *IndexConst(&mut out1).index_mut(2) = 0xadf6c7e5859ce35f;
    *IndexConst(&mut out1).index_mut(3) = 0x615441451df6c379;
}
