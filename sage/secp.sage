...
def sec(name, p, a, b, gx, gy, size):
    ...
    # scalar finite field
    #S = FiniteField(order)
    return { 'name': name, 'p' : p, 'E': E, 'G': G, 'size': size }
...
def secp256k1():
    ...
    return sec("p256k1", p, a, b, gx, gy, 32)
...
def secp256r1():
    ...
    return sec("p256r1", p, a, b, gx, gy, 32)
...
def secp384r1():
    ...
    return sec("p384r1", p, a, b, gx, gy, 48)
...
def secp521r1():
    ...
    return sec("p521r1", p, a, b, gx, gy, 66)
